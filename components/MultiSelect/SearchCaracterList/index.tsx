...
function SearchCaracterList() {
  ...
  return (
    <div className="relative ">
      <div className="  w-full  absolute max-h-96 top-0 right-0 bg-white px-4 rounded-lg pt-2 overflow-auto shadow-navbarShadow">
        <div className="flex items-end sticky top-0 left-0   z-10">
          <button
            type="button"
            className="text-gray-400 backdrop-blur-sm bg-transparent  hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center me-2 opacity-75 mb-2"
